<p align="center">
  <img src="https://readme-typing-svg.herokuapp.com?font=Fira+Code&size=22&duration=3000&pause=800&center=true&vCenter=true&width=750&lines=Hey+there+👋+I'm+Yagnik+Patel!;ICT+Engineering+Student+%7C+Tech+Explorer+%7C+Video+Editor;Aspiring+Entrepreneur+%7C+Creative+Thinker" alt="Yagnik Patel Intro" />
</p>
...
| 🛠 Project | 💡 Description |
|-----------|----------------|
| 🐍 [Snake Game](https://github.com/YagnikPatel22/SnakeGame) | Classic C++ console game with real-time logic |
| 🧱 [Tetris Game](https://github.com/YagnikPatel22/TetrisGame) | Block-stacking Tetris clone in C++ |
| 🔳 [QR Code Generator](https://github.com/YagnikPatel22/QRCodeGenerator) | CLI-based QR code creator using C++ |

> 💡 *More creative projects are on the way...*
...
<p align="center"><i>Thanks for scrolling! Let’s build something meaningful together 🚀</i></p>
